...
function InputGroupAddon({
  ...
  const focusGroupedInput = (target: EventTarget & HTMLElement) => {
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: forwards focus to the grouped input
    <div
      data-slot="input-group-addon"
      data-align={align}
      className={cn(inputGroupAddonVariants({ align }), className)}
      onClick={(e) => {
        focusGroupedInput(e.currentTarget);
      }}
      onKeyDown={(e) => {
