...
type SelectItemsRegistry = Map<unknown, React.ReactNode>;

const SelectItemsRegistryContext = React.createContext<
...
export function SelectItem({
  ...
  const register = React.useContext(SelectItemsRegistryContext);
