...
pub struct Args {
    ...
    #[arg(long, env = "TUNNET_POLICY_KEY")]
    ...
    /// Path to policy signing key file when TUNNET_POLICY_KEY env is unset (dev only).
    #[arg(long, env = "TUNNET_POLICY_KEY_PATH", default_value = "./policy.key")]
