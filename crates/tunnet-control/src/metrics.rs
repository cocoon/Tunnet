...
impl Metrics {
    pub fn new() -> anyhow::Result<Self> {
        ...
        describe_gauge!("tunnet_devices_online", "Devices with live WS");
        describe_gauge!("tunnet_ws_connected", "Currently open WS sessions");
    ...
    pub fn auth_failure(&self, reason: &'static str) {
        counter!("tunnet_auth_failures_total", "reason" => reason).increment(1);
    }

    pub fn ws_connected_inc(&self) {
        gauge!("tunnet_ws_connected").increment(1.0);
    }

    pub fn ws_connected_dec(&self) {
        gauge!("tunnet_ws_connected").decrement(1.0);
    }

    pub fn devices_online_set(&self, n: i64) {
        gauge!("tunnet_devices_online").set(n as f64);
    }
