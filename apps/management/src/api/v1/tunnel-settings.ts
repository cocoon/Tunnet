...
function serializeSettings(
  ...
  return {
    ...
    defaultEdgeId: row.defaultEdgeId,
        ...
        async ({ authContext, body }) => {
          ...
          if (parsed.defaultEdgeId) {
            const edge = await db.query.edges.findFirst({
              where: and(
                eq(schema.edges.id, parsed.defaultEdgeId),
          ...
          const [row] = await db
            ...
            .values({
              ...
              defaultEdgeId: parsed.defaultEdgeId ?? null,
            ...
            .onConflictDoUpdate({
              ...
              set: {
                ...(parsed.defaultEdgeId !== undefined
                  ? { defaultEdgeId: parsed.defaultEdgeId }
                  : {}),
